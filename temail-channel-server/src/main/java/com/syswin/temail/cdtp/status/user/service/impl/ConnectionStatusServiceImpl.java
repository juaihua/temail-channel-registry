package com.syswin.temail.cdtp.status.user.service.impl;

import com.syswin.temail.cdtp.status.user.beans.TemailAccountStatus;
 ...
 *      hashValue： {@link com.syswin.temail.cdtp.status.user.beans.TemailAccountStatus}
 *    2、processes channels info.. (set)
 *      redisKey：temail:hosts:${hostOf}:${processId}
 *      member构成：{@link com.syswin.temail.cdtp.status.user.beans.TemailAccountStatus}
 *  </pre>
 */
@Component
