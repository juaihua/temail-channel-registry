...
public class TemailChannelApplicationTests {
  ...
  public void testUpdateStatus4Update() {
    try {
      ...
      MvcResult result = mockMvc.perform(
          MockMvcRequestBuilders.post("/updateStatus").contentType("application/json;charset=utf-8")
  ...
  public void testServerRegistsAndOffLine() {
    ConnectionStatusServiceImpl connectionStatusService = webApplicationContext
        .getBean(ConnectionStatusServiceImpl.class);
